...
- **A growing perspective library** — 178 lenses and counting, each a discrete analytical protocol drawn from law, finance, engineering, psychology, military strategy, cognitive science, and Charlie Munger's mental models.
...
- **Context efficiency:** A 178-perspective library could consume an entire context window if loaded at once. Selective loading keeps context free for the assessment itself.
...
A trivial topic doesn't need 80% of a 178-perspective library. A critical topic with emerging issues needs more, not a fixed cap. DCIK starts with high-signal perspectives and escalates based on what it finds — not based on an arbitrary percentage.
